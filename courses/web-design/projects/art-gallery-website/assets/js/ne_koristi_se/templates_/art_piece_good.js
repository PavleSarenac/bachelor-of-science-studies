...
class TemplateExtenderArtPiece {
    ...
    constructor(callers_path_to_root) {
    ...
    initBreadcrumbs(relative_url) {
        ...
        let breadcrumbs = document.getElementById('breadcrumbs-list');
        ...
        document.getElementById('art-piece-name').textContent
